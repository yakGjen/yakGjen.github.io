  ...
  function addSummary(data) {
    if (summary === null) {
      ...
      div.innerHTML = `<p><img class="${classSummaryImg}" src="./img/photo.jpg" alt="my photo"></p>
                      <p>Здравствуйте!</p>
                      <p>Меня зовут Евгений Якимчук. Проходил обучение в Образовательном центре Парка высоких технологий по специальности Front-end developer.Выпускным проектом была игра «Теннис» с сохранением данных на сервере с помощью AJAX. Там же проходил стажировку на проекте subbotnik.by. Моя роль заключалась в написании авто-тестов с использованием Protractor по сценариям. После стажировки приступил к изучению английского языка, а также изучал Angular, параллельно отрабатывая полученные навыки на проекте «Домашняя бухгалтерия». На данный момент продолжаю совершенствовать полученный навыки по Angular на проекте сайта Ивацевичской ледовой арены, знакомлюсь с Node.js и продолжаю изучать английский язык.</p>
                      <p>Моя цель на данном этапе - начать карьеру Front-end / Javascript developer в компании с дружным коллективом, с возможностью роста и развития. Получить возможность изучать новые технологии и улучшить свои существующие навыки.</p>
